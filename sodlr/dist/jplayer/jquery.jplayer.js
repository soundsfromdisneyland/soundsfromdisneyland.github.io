    ...
    a.jPlayer.keys = function(b) {
        ...
        options: {
            ...
            cssSelector: {
                ...
                volumeUp: ".jp-volume-up",
                volumeDown: ".jp-volume-down",
        ...
        setMedia: function(b) {
            $(".trackInfoDisplay").html("<div>" + b.comments + "</div>");
            var c = this,
                d = !1,
        ...
        _resetMedia: function() {
            this._resetStatus(), this._updateButtons(!1), this._updateInterface(), this._seeked(), this.internal.poster.jq.show(), clearTimeout(this.internal.htmlDlyCmdId), this.html.active ? this._html_resetMedia() : this.aurora.active ? this._aurora_resetMedia() : this.flash.active && this._flash_resetMedia()
        },
        clearMedia: function() {
        ...
        _updateMute: function(a) {
            a === b && (a = this.options.muted), a ? this.addStateClass("muted") : this.removeStateClass("muted"), this.css.jq.mute.length && this.css.jq.unmute.length && (this.status.noVolume ? (this.css.jq.mute.show(), this.css.jq.unmute.show()) : a ? (this.css.jq.mute.show(), this.css.jq.unmute.show()) : (this.css.jq.mute.show(), this.css.jq.unmute.show()))
        },
        volume: function(a) {
        ...
        volumeUp: function() {
            this.volume(this.options.volume + .1) && this._muted(!1)
        },
        volumeDown: function() {
            this.volume(this.options.volume - .1) && this._muted(!1)
        },
